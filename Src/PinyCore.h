...
void initPinyCore();
typedef void (*LoggerCallback)(const char *, const char *, const char *, ...);
extern LoggerCallback activeLogger_;
inline void registerLogger(LoggerCallback logger) { activeLogger_ = logger; }
