...
void MX_FDCAN2_Init(void)
{
    ...
    hfdcan2.Init.MessageRAMOffset = 856;
...
void MX_FDCAN3_Init(void)
{
    ...
    hfdcan3.Init.MessageRAMOffset = 1712;
...
void MX_USART10_UART_Init(void)
{
    ...
    if (HAL_UARTEx_SetTxFifoThreshold(&huart10, UART_TXFIFO_THRESHOLD_1_8) !=
        HAL_OK) {
        Error_Handler();
    }
    if (HAL_UARTEx_SetRxFifoThreshold(&huart10, UART_RXFIFO_THRESHOLD_1_8) !=
        HAL_OK) {
        Error_Handler();
    }
...
void MX_GPIO_Init(void)
{
    ...
    HAL_GPIO_WritePin(GPIOC,
                      power_1_Pin | power_2_Pin | power_3_Pin | ACC_CS_Pin |
                              GYRO_CS_Pin,
                      GPIO_PIN_RESET);
    ...
    /*Configure GPIO pins : power_1_Pin power_2_Pin power_3_Pin */
    GPIO_InitStruct.Pin = power_1_Pin | power_2_Pin | power_3_Pin;
