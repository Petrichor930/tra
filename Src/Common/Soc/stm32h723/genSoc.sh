...
mkdir -p hal/Drivers/CMSIS/Device/ST/STM32H7xx
cp -r ../../../../ThirdParty/CMSIS_Device_H7/Include/ hal/Drivers/CMSIS/Device/ST/STM32H7xx
cp -r ../../../../ThirdParty/STM32H7xx_HAL_Driver/ hal/Drivers
