...
void DCM_AHRS::updateDCM(float _gx, float _gy, float _gz, float _ax, float _ay, float _az, float _dt)
{
    dt_ = _dt;
    ...
    float P_00 =
        P00_ -
        dt_ * (P05_ * x1_ * 2.0f - P04_ * x2_ * 2.0f + P02_ * (u1 - x4_) * 2.0f -
                P01_ * (u2 - x5_) * 2.0f) -
        dt2 * (-DCMVariance_ +
                x2_ * (P45_ * x1_ - P44_ * x2_ + P24_ * (u1 - x4_) - P14_ * (u2 - x5_)) +
                x1_ * (P45_ * x2_ - P55_ * x1_ - P25_ * (u1 - x4_) + P15_ * (u2 - x5_)) +
                (u2 - x5_) *
                    (P15_ * x1_ - P14_ * x2_ + P12_ * (u1 - x4_) - P11_ * (u2 - x5_)) -
                (u1 - x4_) *
                    (P25_ * x1_ - P24_ * x2_ + P22_ * (u1 - x4_) - P12_ * (u2 - x5_)));
    float P_01 =
        P01_ +
        dt_ * (P05_ * x0_ - P03_ * x2_ - P15_ * x1_ + P14_ * x2_ + P02_ * (u0 - x3_) -
                P12_ * (u1 - x4_) - P00_ * (u2 - x5_) + P11_ * (u2 - x5_)) +
        dt2 * (x2_ * (P35_ * x1_ - P34_ * x2_ + P23_ * (u1 - x4_) - P13_ * (u2 - x5_)) +
                x0_ * (P45_ * x2_ - P55_ * x1_ - P25_ * (u1 - x4_) + P15_ * (u2 - x5_)) +
                (u2 - x5_) *
                    (P05_ * x1_ - P04_ * x2_ + P02_ * (u1 - x4_) - P01_ * (u2 - x5_)) -
                (u0 - x3_) *
                    (P25_ * x1_ - P24_ * x2_ + P22_ * (u1 - x4_) - P12_ * (u2 - x5_)));
    float P_02 =
        P02_ -
        dt_ * (P04_ * x0_ - P03_ * x1_ + P25_ * x1_ - P24_ * x2_ + P01_ * (u0 - x3_) -
                P00_ * (u1 - x4_) + P22_ * (u1 - x4_) - P12_ * (u2 - x5_)) -
        dt2 * (x1_ * (P35_ * x1_ - P34_ * x2_ + P23_ * (u1 - x4_) - P13_ * (u2 - x5_)) -
                x0_ * (P45_ * x1_ - P44_ * x2_ + P24_ * (u1 - x4_) - P14_ * (u2 - x5_)) +
                (u1 - x4_) *
                    (P05_ * x1_ - P04_ * x2_ + P02_ * (u1 - x4_) - P01_ * (u2 - x5_)) -
                (u0 - x3_) *
                    (P15_ * x1_ - P14_ * x2_ + P12_ * (u1 - x4_) - P11_ * (u2 - x5_)));
    float P_03 =
        P03_ - dt_ * (P35_ * x1_ - P34_ * x2_ + P23_ * (u1 - x4_) - P13_ * (u2 - x5_));
    float P_04 =
        P04_ - dt_ * (P45_ * x1_ - P44_ * x2_ + P24_ * (u1 - x4_) - P14_ * (u2 - x5_));
    float P_05 =
        P05_ + dt_ * (P45_ * x2_ - P55_ * x1_ - P25_ * (u1 - x4_) + P15_ * (u2 - x5_));
    float P_11 =
        P11_ +
        dt_ * (P15_ * x0_ * 2.0f - P13_ * x2_ * 2.0f + P12_ * (u0 - x3_) * 2.0f -
                P01_ * (u2 - x5_) * 2.0f) -
        dt2 * (-DCMVariance_ +
                x2_ * (P35_ * x0_ - P33_ * x2_ + P23_ * (u0 - x3_) - P03_ * (u2 - x5_)) +
                x0_ * (P35_ * x2_ - P55_ * x0_ - P25_ * (u0 - x3_) + P05_ * (u2 - x5_)) +
                (u2 - x5_) *
                    (P05_ * x0_ - P03_ * x2_ + P02_ * (u0 - x3_) - P00_ * (u2 - x5_)) -
                (u0 - x3_) *
                    (P25_ * x0_ - P23_ * x2_ + P22_ * (u0 - x3_) - P02_ * (u2 - x5_)));
    float P_12 =
        P12_ -
        dt_ * (P14_ * x0_ - P13_ * x1_ - P25_ * x0_ + P23_ * x2_ + P11_ * (u0 - x3_) -
                P01_ * (u1 - x4_) - P22_ * (u0 - x3_) + P02_ * (u2 - x5_)) +
        dt2 * (x1_ * (P35_ * x0_ - P33_ * x2_ + P23_ * (u0 - x3_) - P03_ * (u2 - x5_)) -
                x0_ * (P45_ * x0_ - P34_ * x2_ + P24_ * (u0 - x3_) - P04_ * (u2 - x5_)) +
                (u1 - x4_) *
                    (P05_ * x0_ - P03_ * x2_ + P02_ * (u0 - x3_) - P00_ * (u2 - x5_)) -
                (u0 - x3_) *
                    (P15_ * x0_ - P13_ * x2_ + P12_ * (u0 - x3_) - P01_ * (u2 - x5_)));
    float P_13 =
        P13_ + dt_ * (P35_ * x0_ - P33_ * x2_ + P23_ * (u0 - x3_) - P03_ * (u2 - x5_));
    float P_14 =
        P14_ + dt_ * (P45_ * x0_ - P34_ * x2_ + P24_ * (u0 - x3_) - P04_ * (u2 - x5_));
    float P_15 =
        P15_ - dt_ * (P35_ * x2_ - P55_ * x0_ - P25_ * (u0 - x3_) + P05_ * (u2 - x5_));
    float P_22 =
        P22_ -
        dt_ * (P24_ * x0_ * 2.0f - P23_ * x1_ * 2.0f + P12_ * (u0 - x3_) * 2.0f -
                P02_ * (u1 - x4_) * 2.0f) -
        dt2 * (-DCMVariance_ +
                x1_ * (P34_ * x0_ - P33_ * x1_ + P13_ * (u0 - x3_) - P03_ * (u1 - x4_)) +
                x0_ * (P34_ * x1_ - P44_ * x0_ - P14_ * (u0 - x3_) + P04_ * (u1 - x4_)) +
                (u1 - x4_) *
                    (P04_ * x0_ - P03_ * x1_ + P01_ * (u0 - x3_) - P00_ * (u1 - x4_)) -
                (u0 - x3_) *
                    (P14_ * x0_ - P13_ * x1_ + P11_ * (u0 - x3_) - P01_ * (u1 - x4_)));
    float P_23 =
        P23_ - dt_ * (P34_ * x0_ - P33_ * x1_ + P13_ * (u0 - x3_) - P03_ * (u1 - x4_));
    float P_24 =
        P24_ + dt_ * (P34_ * x1_ - P44_ * x0_ - P14_ * (u0 - x3_) + P04_ * (u1 - x4_));
    float P_25 =
        P25_ + dt_ * (P35_ * x1_ - P45_ * x0_ - P15_ * (u0 - x3_) + P05_ * (u1 - x4_));
    ...
    float K00 =
        -(S02 * (P_02 * S11 - P_01 * S12) - S01 * (P_02 * S12 - P_01 * S22) +
            P_00 * (S12 * S12) - P_00 * S11 * S22) *
        invPart;
    float K01 =
        -(S12 * (P_02 * S00 - P_00 * S02) - S01 * (P_02 * S02 - P_00 * S22) +
            P_01 * (S02 * S02) - P_01 * S00 * S22) *
        invPart;
    float K02 =
        -(S12 * (P_01 * S00 - P_00 * S01) - S02 * (P_01 * S01 - P_00 * S11) +
            P_02 * (S01 * S01) - P_02 * S00 * S11) *
        invPart;
    float K10 =
        -(S02 * (P_12 * S11 - P_11 * S12) - S01 * (P_12 * S12 - P_11 * S22) +
            P_01 * (S12 * S12) - P_01 * S11 * S22) *
        invPart;
    float K11 =
        -(S12 * (P_12 * S00 - P_01 * S02) - S01 * (P_12 * S02 - P_01 * S22) +
            P_11 * (S02 * S02) - P_11 * S00 * S22) *
        invPart;
    float K12 =
    ...
    float P__03 = -P_03 * K00_1 + K30 * common3 + K31 * common1 + K32 * common2 -
                    K01 * P_13 - K02 * P_23 + K00 * K30 * r_adab +
                    K01 * K31 * r_adab + K02 * K32 * r_adab;
    float P__04 = -P_04 * K00_1 + K40 * common3 + K41 * common1 + K42 * common2 -
                    K01 * P_14 - K02 * P_24 + K00 * K40 * r_adab +
                    K01 * K41 * r_adab + K02 * K42 * r_adab;
    float P__05 = -P_05 * K00_1 + K50 * common3 + K51 * common1 + K52 * common2 -
                    K01 * P_15 - K02 * P_25 + K00 * K50 * r_adab +
    ...
    float P__13 = -P_13 * K11_1 + K30 * common4 + K31 * common6 + K32 * common5 -
                    K10 * P_03 - K12 * P_23 + K10 * K30 * r_adab +
                    K11 * K31 * r_adab + K12 * K32 * r_adab;
    float P__14 = -P_14 * K11_1 + K40 * common4 + K41 * common6 + K42 * common5 -
                    K10 * P_04 - K12 * P_24 + K10 * K40 * r_adab +
                    K11 * K41 * r_adab + K12 * K42 * r_adab;
    float P__15 = -P_15 * K11_1 + K50 * common4 + K51 * common6 + K52 * common5 -
                    K10 * P_05 - K12 * P_25 + K10 * K50 * r_adab +
    ...
    float P__23 = -P_23 * K22_1 + K30 * common7 + K31 * common8 + K32 * common9 -
                    K20 * P_03 - K21 * P_13 + K20 * K30 * r_adab +
                    K21 * K31 * r_adab + K22 * K32 * r_adab;
    float P__24 = -P_24 * K22_1 + K40 * common7 + K41 * common8 + K42 * common9 -
                    K20 * P_04 - K21 * P_14 + K20 * K40 * r_adab +
                    K21 * K41 * r_adab + K22 * K42 * r_adab;
    float P__25 = -P_25 * K22_1 + K50 * common7 + K51 * common8 + K52 * common9 -
                    K20 * P_05 - K21 * P_15 + K20 * K50 * r_adab +
    ...
    P00_ = invlen32 *
            (-x1x1_x2x2 * (-P__00 * x1x1_x2x2 + P__01 * x0_ * x1_ + P__02 * x0_ * x2_) +
            x0_ * x1_ * (-P__01 * x1x1_x2x2 + P__11 * x0_ * x1_ + P__12 * x0_ * x2_) +
            x0_ * x2_ * (-P__02 * x1x1_x2x2 + P__12 * x0_ * x1_ + P__22 * x0_ * x2_));
    P01_ = invlen32 *
            (-x0x0_x2x2 * (-P__01 * x1x1_x2x2 + P__11 * x0_ * x1_ + P__12 * x0_ * x2_) +
            x0_ * x1_ * (-P__00 * x1x1_x2x2 + P__01 * x0_ * x1_ + P__02 * x0_ * x2_) +
            x1_ * x2_ * (-P__02 * x1x1_x2x2 + P__12 * x0_ * x1_ + P__22 * x0_ * x2_));
    P02_ = invlen32 *
            (-x0x0_x1x1 * (-P__02 * x1x1_x2x2 + P__12 * x0_ * x1_ + P__22 * x0_ * x2_) +
            x0_ * x2_ * (-P__00 * x1x1_x2x2 + P__01 * x0_ * x1_ + P__02 * x0_ * x2_) +
            x1_ * x2_ * (-P__01 * x1x1_x2x2 + P__11 * x0_ * x1_ + P__12 * x0_ * x2_));
    P03_ = -invlen3 * (-P__03 * x1x1_x2x2 + P__13 * x0_ * x1_ + P__23 * x0_ * x2_);
    P04_ = -invlen3 * (-P__04 * x1x1_x2x2 + P__14 * x0_ * x1_ + P__24 * x0_ * x2_);
    P05_ = -invlen3 * (-P__05 * x1x1_x2x2 + P__15 * x0_ * x1_ + P__25 * x0_ * x2_);
    P11_ = invlen32 *
            (-x0x0_x2x2 * (-P__11 * x0x0_x2x2 + P__01 * x0_ * x1_ + P__12 * x1_ * x2_) +
            x0_ * x1_ * (-P__01 * x0x0_x2x2 + P__00 * x0_ * x1_ + P__02 * x1_ * x2_) +
            x1_ * x2_ * (-P__12 * x0x0_x2x2 + P__02 * x0_ * x1_ + P__22 * x1_ * x2_));
    P12_ = invlen32 *
            (-x0x0_x1x1 * (-P__12 * x0x0_x2x2 + P__02 * x0_ * x1_ + P__22 * x1_ * x2_) +
            x0_ * x2_ * (-P__01 * x0x0_x2x2 + P__00 * x0_ * x1_ + P__02 * x1_ * x2_) +
            x1_ * x2_ * (-P__11 * x0x0_x2x2 + P__01 * x0_ * x1_ + P__12 * x1_ * x2_));
    P13_ = -invlen3 * (-P__13 * x0x0_x2x2 + P__03 * x0_ * x1_ + P__23 * x1_ * x2_);
    P14_ = -invlen3 * (-P__14 * x0x0_x2x2 + P__04 * x0_ * x1_ + P__24 * x1_ * x2_);
    P15_ = -invlen3 * (-P__15 * x0x0_x2x2 + P__05 * x0_ * x1_ + P__25 * x1_ * x2_);
    P22_ = invlen32 *
            (-x0x0_x1x1 * (-P__22 * x0x0_x1x1 + P__02 * x0_ * x2_ + P__12 * x1_ * x2_) +
            x0_ * x2_ * (-P__02 * x0x0_x1x1 + P__00 * x0_ * x2_ + P__01 * x1_ * x2_) +
            x1_ * x2_ * (-P__12 * x0x0_x1x1 + P__01 * x0_ * x2_ + P__11 * x1_ * x2_));
    P23_ = -invlen3 * (-P__23 * x0x0_x1x1 + P__03 * x0_ * x2_ + P__13 * x1_ * x2_);
    P24_ = -invlen3 * (-P__24 * x0x0_x1x1 + P__04 * x0_ * x2_ + P__14 * x1_ * x2_);
    P25_ = -invlen3 * (-P__25 * x0x0_x1x1 + P__05 * x0_ * x2_ + P__15 * x1_ * x2_);
    P33_ = P__33;
    P34_ = P__34;
    P35_ = P__35;
    P44_ = P__44;
