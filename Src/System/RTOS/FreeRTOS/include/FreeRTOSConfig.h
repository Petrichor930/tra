...
//1启用特殊方法来选择下一个要运行的任务,一般是硬件计算前导零指令
...
#define configUSE_TASK_FPU_SUPPORT               2 //开启浮点数支持，如果使用浮点数必须开启
...
// #define portCONFIGURE_TIMER_OF_INT_SOURCE()

// NOTE: wait for setting the timer of interrupt source
