...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOC, power_1_Pin|power_2_Pin|power_3_Pin|ACC_CS_Pin
...
void MX_GPIO_Init(void)
{
    ...
    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(GPIOC, power_1_Pin | power_2_Pin | power_3_Pin | ACC_CS_Pin | GYRO_CS_Pin,
                      GPIO_PIN_RESET);
